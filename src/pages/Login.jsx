...
// AuthContext bilan bir xil (@kafe.uz) bo'lishi shart
// ==========================================
...
export default function Login() {
  ...
  function validate() {
    ...
    if (!username.trim()) {
      next.username = "Login kiritilishi shart";
    }
  ...
  async function handleSubmit(e) {
    ...
    console.log("Login qilinmoqda:", loginEmail);
    ...
    try {
      ...
      console.error("Firebase login xatoligi:", err);

      // 2. FIRESTORE FALLBACK (Username yoki Email bo'yicha)
      try {
        ...
        if (!querySnapshot.empty) {
          ...
          if (staffUser.status === "inactive") {
            setFormError("Sizning hisobingiz bloklangan.");
            return;
          }
        ...
        console.error("Firestore'dan tekshirishda xatolik:", firestoreErr);
