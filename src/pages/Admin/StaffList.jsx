...
const chefTypeLabels = {
  salatchi: "🥗 Salatchi",
  shashlikchi: "🍢 Shashlikchi",
  somsachi: "🥟 Somsachi",
  pishiriqchi: "🍰 Pishiriqchi",
  issiq_taomchi: "🍲 Issiq taomchi",
};
...
export default function StaffList() {
  ...
  const [salaryModalPerson, setSalaryModalPerson] =
    useState(null);
  ...
  const handleChange = (e) => {
    ...
    // ⭐ Agar Oshpazdan boshqa lavozim
    // tanlansa chefType tozalanadi
                      ...
                      <div className="flex justify-between items-start gap-2">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-1 mt-1">
                            ...
                            <p className="text-[11px] text-amber-800 font-medium bg-amber-50 border border-amber-100 px-2 py-0.5 rounded-md inline-block">
                            ...
                            {/* ⭐ AGAR OSHPAZ BO'LSA TURI */}
                            {person.role ===
                              "chef" &&
                              person.chefType && (

                                <p className="text-[11px] text-green-700 font-semibold bg-green-50 border border-green-100 px-2 py-0.5 rounded-md inline-block">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-gray-400 mt-1">
                  ...
                  Firebase'dagi to'langan
                  buyurtmalardan avtomatik
                  hisoblanadi.
              ...
              {form.role === "chef" && (
                ...
                <div className="rounded-xl border border-green-200 bg-green-50/50 p-3">
                  ...
                  >
                    ...
                    <option value="">
                      Oshpaz turini tanlang
                    </option>


                    <option value="salatchi">
                      🥗 Salatchi
                    </option>


                    <option value="shashlikchi">
                      🍢 Shashlikchi
                    </option>


                    <option value="somsachi">
                      🥟 Somsachi
                    </option>


                    <option value="pishiriqchi">
                      🍰 Pishiriqchi
                    </option>


                    <option value="issiq_taomchi">
                      🍲 Issiq taomchi
                    </option>
                  ...
                  <p className="text-[10px] text-green-700 mt-2">
                    ...
                    Bu oshpaz faqat shu turga
                    biriktirilgan taomlarni
                    tayyorlaydi.
